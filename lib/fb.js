...
var _require = require('../package.json'),
    ...
    parseOAuthApiResponse = function parseOAuthApiResponse(body) {
	...
	for (let key in params) {
		...
		if (value && typeof value !== 'string') {
			...
			let val = typeof value === 'object' && (_context = value, has).call(_context, 'value') && (_context = value, has).call(_context, 'options') ? value.value : value;
...
let Facebook = (_class = class Facebook {
  ...
  */
	[oauthRequest](path, method, params, cb) {
		...
		(0, _request2.default)(requestOptions, (error, response, body) => {
			if (error !== null) {
